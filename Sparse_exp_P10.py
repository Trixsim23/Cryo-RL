...
def run_experiment_1():
    ...
    #ALL ENVIRONMENTS HAVE THE SAME ACTION SPACE
    ...
    create_projections = True  # Set to True if you want visualizations
    ...
    if create_projections:
        ...
        print(f"    renderings (disabled for speed)")
