...
if __name__ == "__main__":
    ...
    MODEL_PATH = "./experiment_3_20250727-175943/trained_model.zip"  # UPDATE THIS PATH
    RESULTS_FOLDER = "./dense_reward_exp3_10_patients"
    EXPERIMENT_NAME = "Dense_Reward_RL_Reevaluation"
    ENVIRONMENT_TYPE = "dense_reward"  # or "standard"
    ...
    if not os.path.exists(MODEL_PATH):
        ...
        print("Example paths:")
        print("  ./experiment_3_enhanced_TIMESTAMP/trained_model.zip")
