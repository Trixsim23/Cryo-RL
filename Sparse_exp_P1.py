"""
Enhanced Experiment 1: Current Method (Baseline) with Comprehensive Visualization
================================================================================

This experiment uses your current RL approach with comprehensive visualization enhancements:
- Standardized action spaces across all environments
- Enhanced 2D visualization (your original style)
- Multi-view medical imaging (sagittal, coronal, axial views)
- Detailed quantitative analysis plots
- Optional 3D volume rendering
- Comprehensive JSON results for each patient

Usage:
    python exp1.py

Results saved in: ./experiment_1_comprehensive_results_TIMESTAMP/
"""
...
# ============================================================================
# ENHANCED EXPERIMENT 1: CURRENT METHOD WITH COMPREHENSIVE VISUALIZATION
# ============================================================================

def run_experiment_1_enhanced():
    """Run Enhanced Experiment 1: Current Method with Comprehensive Visualization"""
    
    print("=" * 80)
    print("ENHANCED EXPERIMENT 1: CURRENT METHOD WITH COMPREHENSIVE VISUALIZATION")
    print("=" * 80)
    print("This experiment uses your current RL approach with major enhancements:")
    print("✓ Discrete action space (STANDARDIZED)")
    print("✓ Sparse reward function")
    print("✓ PPO algorithm")
    print("✓ Fixed environment action space compatibility")
    print("✓ Enhanced 2D visualization (your original style)")
    ...
    print("✓ Optional 3D volume rendering")
    print("=" * 80)
    ...
    timesteps_per_patient = 5000000000  # Adjust as needed
    ...
    # Train on all patients in sequence using the same model
    ...
    if callback.episode_rewards and callback.dice_scores:
        ...
        ax1.set_title('Enhanced Experiment 1: Training Progress - Rewards', fontsize=16)
        ...
        ax2.set_title('Enhanced Experiment 1: Training Progress - Dice Scores', fontsize=16)
    ...
    print("\n" + "="*60)
    print("RUNNING ENHANCED EVALUATION WITH COMPREHENSIVE VISUALIZATION")
    print("="*60)
    ...
    if create_projections:
        ...
        print("visualisations disabled for speed")
    ...
    print(f"\n" + "="*60)
    print("ENHANCED EXPERIMENT 1 COMPREHENSIVE RESULTS")
    print("="*60)
